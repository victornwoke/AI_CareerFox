import {
  ...
  jsonResponse,
  readJsonBody,
  validateInterviewFeedbackInput,
  validateRequestSize,
...
export async function POST(request: Request) {
  ...
  const validation = validateInterviewFeedbackInput(jsonBody.data);
  ...
  try {
    const feedback = await createInterviewFeedback(validation.data);
