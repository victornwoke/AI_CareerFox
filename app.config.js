    ...
    ios: {
      ...
      infoPlist: {
        NSCameraUsageDescription:
          "CareerFox AI uses the camera for interview practice and avatar-based voice sessions.",
        NSMicrophoneUsageDescription:
          "CareerFox AI uses the microphone to capture your spoken interview answers.",
      },
    },
    android: {
      adaptiveIcon: {
